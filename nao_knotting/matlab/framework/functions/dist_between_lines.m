function [dist Pc Qc]=dist_between_lines(L1,L2)
...
% L1=rand(2,3);
% L2=rand(2,3);
% [d Pc Qc]=distBW2lines(L1,L2) this is the original name of the function
% it was renamed in order to comply with the coding conventions of the project.
%
