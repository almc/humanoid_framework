function [grad, end_eff_ref] = biot_savart_run1(end_effector, loop_pos, loop, biot_savart, world_to_loop)
...
grad              = world_to_loop \ grad_in_loop;

end_eff_ref = end_effector + grad;
