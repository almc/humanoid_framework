...
%         disp('regrasping other end of the rope');
    ...
    case 6
        arm1.ref(:,n) = [  1.0, 1.0, 2.5]';
        arm2.ref(:,n) = [ -1.0, 1.0, 2.5]';
        base.ref(:,n) = [  0.0, 2.0, 0 ]';
...
%             [arm2.grad, arm2.ref(:,n)] = biot_savart_run (arm2.ef, rope_loop.pos,     rope_loop, biot_savart, world_to_rope_loop_3x3);
            [arm2.grad, arm2.ref(:,n)] = biot_savart_run2(arm2.ef, rope_loop.pos,     rope_loop, biot_savart, world_to_rope_loop_4x4);
        end
